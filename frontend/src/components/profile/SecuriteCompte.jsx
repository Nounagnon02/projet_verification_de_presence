...
// L'étape « start » n'a pas de titre : la fenêtre n'est jamais ouverte à ce moment-là.
const TITRE_ETAPE_2FA = { qr: 'Scannez le QR code', done: 'Codes de récupération' };
...
export default function SecuriteCompte({ deuxFacteursActive = false, onDeuxFacteursChange }) {
  ...
  return (
    <section aria-label="Sécurité du compte" className="space-y-8">
      ...
      <Modal isOpen={show2FAModal} onClose={handleCloseModal} title={TITRE_ETAPE_2FA[twoFAStep]} size="md">
        {twoFAError && (
      ...
      <Modal isOpen={showDisableConfirm} onClose={() => setShowDisableConfirm(false)} title="Désactiver la 2FA" size="sm">
        <div className="flex items-center gap-3 mb-6">
