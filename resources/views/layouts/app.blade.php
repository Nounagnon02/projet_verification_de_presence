                    ...
                    <div class="max-w-7xl mx-auto py-4 px-4 sm:py-6 sm:px-6 md:px-8 lg:px-10 xl:px-12">
                        <div class="flex justify-between items-center">
                            ...
                            <div class="flex items-center space-x-2">
                                <x-color-picker />
                                <x-theme-toggle />
                                <button onclick="showShortcuts()" class="p-2 rounded-lg bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors" title="Raccourcis clavier (?)">
