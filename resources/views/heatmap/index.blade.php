        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-card dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6">
                <form method="GET" action="{{ route('heatmap.index') }}" class="flex flex-wrap items-end gap-4">
                    <div>
                        <label class="block text-sm font-medium text-ink-soft dark:text-gray-300 mb-1">Date de début</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-ink-soft dark:text-gray-300 mb-1">Date de fin</label>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                ...
                <div class="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 p-4 rounded-lg border border-green-200 dark:border-green-800">
                    ...
                    <div class="text-sm text-confirm dark:text-green-400">Événements</div>
                </div>
