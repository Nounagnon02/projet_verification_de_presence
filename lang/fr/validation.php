...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Traduction des messages d'erreur du validateur. Sans ce fichier, Laravel
    | retombe sur l'anglais : « The phone has already been taken. » s'affichait
    | dans une application entièrement française.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Le :attribute donné est apparu dans une fuite de données. Merci d\'en choisir un autre.',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Remplace le nom technique du champ dans le message d'erreur : « Cette
    | valeur de téléphone est déjà utilisée. » au lieu de « … de phone … ».
    |
    */
    ...
    'attributes' => [
        ...
        'members.*.phone' => 'téléphone du membre',
        'members.*.rgpd_consent' => 'consentement du membre',
        ...
        'radius' => 'rayon',
        'is_active' => 'actif',
        'admin_email' => 'email du responsable',
        'admin_phone' => 'téléphone du responsable',
        'alert_after_minutes' => 'délai avant alerte',
        'alert_message_template' => 'modèle de message',
        'reminder_hours_before' => 'heures avant rappel',
        'absence_alerts_enabled' => 'alertes d\'absence',
