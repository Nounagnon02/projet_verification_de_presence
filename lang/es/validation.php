...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'group_ids.*' => 'grupo',
        'members' => 'miembros',
        'members.*.name' => 'nombre del miembro',
        'members.*.phone' => 'teléfono del miembro',
        'members.*.rgpd_consent' => 'consentimiento del miembro',
        'rgpd_consent' => 'consentimiento RGPD',
        ...
        'radius' => 'radio',
        'is_active' => 'activo',
        'admin_email' => 'correo del responsable',
        'admin_phone' => 'teléfono del responsable',
        'alert_after_minutes' => 'retardo antes de la alerta',
        'alert_message_template' => 'plantilla del mensaje',
        'reminder_hours_before' => 'horas antes del recordatorio',
        'absence_alerts_enabled' => 'alertas de ausencia',
